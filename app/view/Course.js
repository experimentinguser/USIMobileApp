	...
	config: {
		...
		listeners: {
			painted: function(){
				...
				var description_html = data.description == null ? '' : '<div class="course_description"><div class="label">'+Ux.locale.Manager.get('label.description')+':</div>'+ data.description + '</div>';
